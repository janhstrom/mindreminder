...
import type { AuthUser } from "@/lib/auth-supabase" // Changed from UserType to AuthUser
import { useTheme } from "next-themes"
import { useAuth } from "@/components/auth/auth-provider" // Import useAuth for logout
import { useRouter } from "next/navigation"

interface HeaderProps {
  user: AuthUser // Changed from UserType to AuthUser
  // onLogout is now handled by useAuth
  // onProfileClick is now handled by router
  onMenuClick: () => void
}
