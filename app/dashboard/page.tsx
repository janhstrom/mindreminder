...
export default function DashboardPage() {
  ...
  const handleMicroActionAdded = async (microActionData: any) => {
    try {
      ...
      loadDashboardData() // Reload to show new micro-action
    } catch (error) {
  ...
  const handleMicroActionDelete = async (id: string) => {
    try {
      ...
      loadDashboardData() // Reload to remove deleted action
    } catch (error) {
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <h4 className="font-medium text-gray-900">Quick Micro-Actions</h4>
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        >
                          <div>
                            ...
                            <div className="text-xs text-gray-500">30 sec</div>
                          </div>
                        </Button>
                        <Button
                          size="sm"
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-sm text-green-600">Physical wellness</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
                <CardContent className="p-4 text-center">
                  <div className="text-2xl mb-2">🧠</div>
                  <h3 className="font-semibold text-blue-800">Learning</h3>
                  <p className="text-sm text-blue-600">Knowledge & skills</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
                <CardContent className="p-4 text-center">
                  <div className="text-2xl mb-2">🧘</div>
                  <h3 className="font-semibold text-purple-800">Mindfulness</h3>
                  <p className="text-sm text-purple-600">Mental clarity</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
                <CardContent className="p-4 text-center">
                  <div className="text-2xl mb-2">🎯</div>
                  <h3 className="font-semibold text-orange-800">Productivity</h3>
                  <p className="text-sm text-orange-600">Getting things done</p>
                </CardContent>
              </Card>
            </div>
          </TabsContent>
